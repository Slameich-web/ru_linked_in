    ...
    <div>
      ...
      <div className='article_text_page'>
        ...
        <h3 className='text'>
          ...
          perferendis magni numquam earum doloremque ab cum sequi cupiditate
          aliquam commodi repellat, veritatis praesentium pariatur quis
          accusantium porro sint ullam vel?
        </h3>
      </div>
    </div>
  );
